...
final class ConferenceEventParserTests: XCTestCase {
    ...
    func testEventWithoutName() throws {
        ...
        XCTAssertNil(parser.conferenceEvent(from: event))
    }

    func testConferenceEventWithoutData() throws {
        let event = HTTPEvent(
            id: "1",
    ...
    func testConferenceEventWithInvalidData() throws {
        let event = HTTPEvent(
            id: "1",
            name: "message_received",
            data: "",
    ...
    func testMessageReceived() throws {
        ...
        let message = parser.conferenceEvent(from: event)
    ...
    func testPresentationStart() throws {
        let details = PresentationStartMessage(
            presenterName: "Name",
            presenterUri: "URI"
        )
